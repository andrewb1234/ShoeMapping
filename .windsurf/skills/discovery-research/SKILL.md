...
description: Compressed decision logic, frameworks, and quality gates for running product discovery 'end-to-end:' framing problems, interviewing customers, mapping jobs and journeys, generating solutions, and validating hypotheses before committing to build.
